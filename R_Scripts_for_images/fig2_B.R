...
c1_gs<-size_rep_slope_pvalue_df %>%
...
c2_gs<-size_rep_slope_pvalue_df %>%
...
c3_gs<-size_rep_slope_pvalue_df %>%
...
c4_gs<-size_rep_slope_pvalue_df %>%
...
c5_gs<-size_rep_slope_pvalue_df %>%
...
my_plot_gs<-ggarrange(c1_gs,c2_gs,c3_gs,c4_gs,c5_gs,nrow = 1, widths=c(1,0.7,0.7,0.7,0.7),label.y=)+
  geom_hline(yintercept = 11.5)
pvalue_gs_plot_combined<-annotate_figure(my_plot_gs, left = textGrob("                 Genus                                              Phylum", rot = 90, vjust = 1, gp = gpar(cex = 1)),
                    top = textGrob("Slopes of regression of genome size against environmental parameters", gp = gpar(cex = 1)))+
...
pvalue_gs_plot_combined



#out_file<-"/home/hb0358/Disk2/Disk2/Data/nextcloud/Sciebo/mag+gen_spec/MAGs/REDONE_NEW/Final_Set/pvalue_GS.svg"
#ggsave(file=out_file,device="svg",plot=pvalue_gs_plot_combined,width=1892, height=901, units="px",dpi=150)

#combined_fig2<-ggarrange(pvalue_gc_plot_combined,pvalue_gs_plot_combined,ncol=1,labels = c("(A)","(B)"))
#combined_fig2
#out_file_combined_fig2s<-"/home/hb0358/Disk2/Disk2/Data/nextcloud/Sciebo/mag+gen_spec/MAGs/REDONE_NEW/Final_Set/fig2/fi2-pstr-co.svg"
#out_file_combined_fig2p<-"/home/hb0358/Disk2/Disk2/Data/nextcloud/Sciebo/mag+gen_spec/MAGs/REDONE_NEW/Final_Set/fig2/fi2-pstr-co.png"
#ggsave(file=out_file_combined_fig2s,device="svg",plot=combined_fig2,width=1892, height=1892, units="px",dpi=150)
#ggsave(file=out_file_combined_fig2p,device="png",plot=combined_fig2,width=1892, height=1892, units="px",dpi=150)